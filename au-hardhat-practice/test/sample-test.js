...
//   it("should change word to Hola", async function () {
//     const ModifyString = await ethers.getContractFactory("ModifyString")

//     const contractString = await ModifyString.deploy("Adios")

//     await contract.deploy()

//     await contract.modifyToString()

//     const newWord = await contract.word()
//     assert.equal(newWord.toString(), "Hola")
//   })
// })
